...
class Jogador(object):
    def __init__(self, permutation_size, hidden_size = 100, gamma = 1, temperature = 60, movesLimit = 30, memoryCapacity = 30):
...
idiota = Jogador(6)
idiota.bkpTrain(3000)
#idiota.runEpocas(1000)
idiota.goIdentity([2,1,5,6,3,4])
