...
idiota.saveNetwork('network_v2_level1.joblib')

idiota.easyTrain(2,500000)
idiota.saveNetwork('network_v2_level2.joblib')

idiota.easyTrain(3,300000)
idiota.saveNetwork('network_v2_level3.joblib')

idiota.easyTrain(4,250000)
idiota.saveNetwork('network_v2_level4.joblib')

idiota.easyTrain(5,180000)
idiota.saveNetwork('network_v2_level5.joblib')

idiota.easyTrain(6,140000)
idiota.saveNetwork('network_v2_level6.joblib')

idiota.easyTrain(7,100000)
idiota.saveNetwork('network_v2_level7.joblib')

idiota.easyTrain(8,80000)
idiota.saveNetwork('network_v2_level8.joblib')

idiota.easyTrain(9,50000)
idiota.saveNetwork('network_v2_level9.joblib')

idiota.runEpocas(50000)
idiota.saveNetwork('network_v2_level10.joblib')

idiota.runEpocas(50000)
idiota.saveNetwork('network_v2_level11.joblib')

idiota.runEpocas(50000)
idiota.saveNetwork('network_v2_level12.joblib')

idiota.runEpocas(50000)
idiota.saveNetwork('network_v2_level13.joblib')

idiota.runEpocas(50000)
idiota.saveNetwork('network_v2_level14.joblib')

idiota.runEpocas(50000)
idiota.saveNetwork('network_v2_level15.joblib')

idiota.runEpocas(50000)
idiota.saveNetwork('network_v2_level16.joblib')

idiota.runEpocas(50000)
idiota.saveNetwork('network_v2_level17.joblib')

idiota.runEpocas(50000)
idiota.saveNetwork('network_v2_level18.joblib')

idiota.runEpocas(50000)
idiota.saveNetwork('network_v2_level19.joblib')

idiota.runEpocas(50000)
idiota.saveNetwork('network_v2_level20.joblib')